(function ContextMenu($angular) {
     ...
     * @link https://github.com/Wildhoney/ngContextMenu
     */
    module.directive('contextMenu', ['$window', '$http', '$interpolate', '$compile', '$templateCache', '$document', 'contextMenu',

    function contextMenuDirective($window, $http, $interpolate, $compile, $templateCache, $document, contextMenu) {
        ...
        return {
            ...
            controller: ['$scope', function controller($scope) {
                ...
                $scope.$on("$destroy", $scope.cancelOne);
            }],
            ...
            link: function link(scope, element) {
                ...
                scope.render = function render(event) {
                    ...
                    $document.find('body').append(compiledTemplate);
                    ...
                    scope.menu    = compiledTemplate; //$angular.element(nativeElement.childNodes[childCount - 1]);
